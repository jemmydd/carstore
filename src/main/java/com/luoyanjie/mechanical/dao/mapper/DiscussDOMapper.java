...
public interface DiscussDOMapper {
    ...
    List<DiscussDO> searchWithOutRequest(@Param("publishUserId") Integer publishUserId);
    ...
    List<DiscussDO> searchForAdmin(@Param("title") String title);

    void readBatch(@Param("ids") List<Integer> ids);
}