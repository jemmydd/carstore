...
CREATE TABLE `feedback` (
	...
	`images` VARCHAR(5000) NULL DEFAULT NULL COMMENT '反馈图片',
	`is_deal` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否处理',
	`deal_message` VARCHAR(500) NULL DEFAULT NULL COMMENT '处理内容',
...
CREATE TABLE `vip_config` (
	...
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`days` VARCHAR(5) NOT NULL COMMENT '会员有效天数',
	`price` DECIMAL(10,2) NOT NULL COMMENT '价格',
	`description` VARCHAR(100) NULL DEFAULT NULL COMMENT '描述',
	`is_limit` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否限购',
	PRIMARY KEY (`id`)
)
COMMENT='会员配置表'
COLLATE='utf8mb4_general_ci'
...
CREATE TABLE `vip_record` (
	...
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`user_id` INT(11) NOT NULL COMMENT '用户id',
	`days` VARCHAR(5) NOT NULL COMMENT '购买/开通天数',
	`price` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '价格',
	`type` TINYINT(2) NOT NULL COMMENT '购买方式，0-用户购买，1-后台开通',
	PRIMARY KEY (`id`)
)
COMMENT='会员开通记录表'
COLLATE='utf8mb4_general_ci'
...
CREATE TABLE `message_record` (
	...
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`user_ids` VARCHAR(1000) NULL DEFAULT NULL COMMENT '发送的用户id，NULL代表全部用户',
...
CREATE TABLE `news` (
	...
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`image` VARCHAR(500) NOT NULL COMMENT '海报图片',
	`type_id` INT NOT NULL COMMENT '主题id',
	`is_valid` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否生效',
	PRIMARY KEY (`id`)
)
COMMENT='海报表'
COLLATE='utf8mb4_general_ci'
...
CREATE TABLE `news_type` (
	...
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`name` VARCHAR(500) NOT NULL COMMENT '海报图片',
	PRIMARY KEY (`id`)
)
COMMENT='海报主题表'
COLLATE='utf8mb4_general_ci'
